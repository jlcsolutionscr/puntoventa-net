...
namespace LeandroSoftware.ServicioWeb.WebServer.Controllers
{
    ...
    public class EjecutarConsultaController : ControllerBase
    {
        ...
        private static bool bolFiltraEstado;
        ...
        public string EjecutarConsulta([FromBody] string strDatos)
        {
            ...
            switch (strNombreMetodo)
            {
                ...
                case "ObtenerReporteVentasProductoTransitorio":
                    ...
                    if (listadoReporteVentasProductoTransitorio.Count > 0)
                        strRespuesta = JsonConvert.SerializeObject(listadoReporteVentasProductoTransitorio);
                    break;
                ...
                case "ObtenerTotalListaFacturas":
                    ...
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    intTotalLista = _servicioFacturacion.ObtenerTotalListaFacturas(intIdEmpresa, intIdSucursal, bolExcluyeNulos, intIdLlave1, strNombre, strIdentificacion, strFechaFinal);
                    strRespuesta = JsonConvert.SerializeObject(intTotalLista);
                    break;
                case "ObtenerListadoFacturas":
                    ...
                    strIdentificacion = parametrosJO.Property("Identificacion") != null ? parametrosJO.Property("Identificacion").Value.ToString() : "";
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    IList<FacturaDetalle> listadoFacturas = _servicioFacturacion.ObtenerListadoFacturas(intIdEmpresa, intIdSucursal, bolExcluyeNulos, intNumeroPagina, intFilasPorPagina, intIdLlave1, strNombre, strIdentificacion, strFechaFinal);
                ...
                case "ObtenerTotalListaProformas":
                    intIdEmpresa = int.Parse(parametrosJO.Property("IdEmpresa").Value.ToString());
                    intIdSucursal = int.Parse(parametrosJO.Property("IdSucursal").Value.ToString());
                    bolFiltraEstado = parametrosJO.Property("FiltraEstado") != null ? bool.Parse(parametrosJO.Property("FiltraEstado").Value.ToString()) : true;
                    bolAplicado = bool.Parse(parametrosJO.Property("Aplicado").Value.ToString());
                    bolExcluyeAplicados = parametrosJO.Property("ExcluyeAplicados") != null ? bool.Parse(parametrosJO.Property("ExcluyeAplicados").Value.ToString()) : false;
                    bolExcluyeNulos = parametrosJO.Property("ExcluyeNulos") != null ? bool.Parse(parametrosJO.Property("ExcluyeNulos").Value.ToString()) : false;
                    intIdLlave1 = parametrosJO.Property("IdProforma") != null ? int.Parse(parametrosJO.Property("IdProforma").Value.ToString()) : 0;
                    strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    intTotalLista = _servicioFacturacion.ObtenerTotalListaProformas(intIdEmpresa, intIdSucursal, bolFiltraEstado, bolAplicado, bolExcluyeAplicados, bolExcluyeNulos, intIdLlave1, strNombre, strFechaFinal);
                    strRespuesta = JsonConvert.SerializeObject(intTotalLista);
                    break;
                case "ObtenerListadoProformas":
                    ...
                    strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    IList<FacturaDetalle> listadoProformas = _servicioFacturacion.ObtenerListadoProformas(intIdEmpresa, intIdSucursal, bolFiltraEstado, bolAplicado, bolExcluyeAplicados, bolExcluyeNulos, intNumeroPagina, intFilasPorPagina, intIdLlave1, strNombre, strFechaFinal);
                ...
                case "ObtenerTotalListaOrdenServicio":
                    ...
                    bolFiltraEstado = parametrosJO.Property("FiltraEstado") != null ? bool.Parse(parametrosJO.Property("FiltraEstado").Value.ToString()) : true;
                    bolAplicado = bool.Parse(parametrosJO.Property("Aplicado").Value.ToString());
                    bolExcluyeAplicados = parametrosJO.Property("ExcluyeAplicados") != null ? bool.Parse(parametrosJO.Property("ExcluyeAplicados").Value.ToString()) : parametrosJO.Property("ExcluyeCancelados") != null ? bool.Parse(parametrosJO.Property("ExcluyeCancelados").Value.ToString()) : false;
                    bolExcluyeNulos = parametrosJO.Property("ExcluyeNulos") != null ? bool.Parse(parametrosJO.Property("ExcluyeNulos").Value.ToString()) : false;
                    intIdLlave1 = parametrosJO.Property("IdOrdenServicio") != null ? int.Parse(parametrosJO.Property("IdOrdenServicio").Value.ToString()) : 0;
                    strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    intTotalLista = _servicioFacturacion.ObtenerTotalListaOrdenServicio(intIdEmpresa, intIdSucursal, bolFiltraEstado, bolAplicado, bolExcluyeAplicados, bolExcluyeNulos, intIdLlave1, strNombre, strFechaFinal);
                    strRespuesta = JsonConvert.SerializeObject(intTotalLista);
                    break;
                case "ObtenerListadoOrdenServicio":
                    ...
                    strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    IList<FacturaDetalle> listadoOrdenServicio = _servicioFacturacion.ObtenerListadoOrdenServicio(intIdEmpresa, intIdSucursal, bolFiltraEstado, bolAplicado, bolExcluyeAplicados, bolExcluyeNulos, intNumeroPagina, intFilasPorPagina, intIdLlave1, strNombre, strFechaFinal);
                ...
                case "ObtenerTotalListaApartados":
                    ...
                    strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    intTotalLista = _servicioFacturacion.ObtenerTotalListaApartados(intIdEmpresa, intIdSucursal, bolFiltraEstado, bolAplicado, bolExcluyeAplicados, bolExcluyeNulos, intIdLlave1, strNombre, strFechaFinal);
                    strRespuesta = JsonConvert.SerializeObject(intTotalLista);
                    break;
                case "ObtenerListadoApartados":
                    ...
                    strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    IList<FacturaDetalle> listadoApartados = _servicioFacturacion.ObtenerListadoApartados(intIdEmpresa, intIdSucursal, bolFiltraEstado, bolAplicado, bolExcluyeAplicados, bolExcluyeNulos, intNumeroPagina, intFilasPorPagina, intIdLlave1, strNombre, strFechaFinal);
                ...
                case "ObtenerListadoCuentasPorCobrar":
                    ...
                    break;
                case "ObtenerTotalListaMovimientosCxC":
                    intIdEmpresa = int.Parse(parametrosJO.Property("IdEmpresa").Value.ToString());
                    intIdSucursal = int.Parse(parametrosJO.Property("IdSucursal").Value.ToString());
                    intIdCuenta = int.Parse(parametrosJO.Property("IdMov").Value.ToString());
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    intTotalLista = _servicioCuentaPorProcesar.ObtenerTotalListaMovimientosCxC(intIdEmpresa, intIdSucursal, intIdCuenta, strFechaFinal);
                    strRespuesta = JsonConvert.SerializeObject(intTotalLista);
                    break;
                ...
                case "ObtenerListadoCuentasPorPagar":
                    ...
                    break;
                case "ObtenerTotalListaMovimientosCxP":
                    intIdEmpresa = int.Parse(parametrosJO.Property("IdEmpresa").Value.ToString());
                    intIdSucursal = int.Parse(parametrosJO.Property("IdSucursal").Value.ToString());
                    intIdCuenta = int.Parse(parametrosJO.Property("IdMov").Value.ToString());
                    strFechaFinal = parametrosJO.Property("FechaFinal") != null ? parametrosJO.Property("FechaFinal").Value.ToString() : "";
                    intTotalLista = _servicioCuentaPorProcesar.ObtenerTotalListaMovimientosCxP(intIdEmpresa, intIdSucursal, intIdCuenta, strFechaFinal);
                    strRespuesta = JsonConvert.SerializeObject(intTotalLista);
                    break;
                ...
                case "ObtenerAsiento":
                    ...
                    break;
                case "ObtenerListadoCuentasParaMovimientos":
                    intIdEmpresa = int.Parse(parametrosJO.Property("IdEmpresa").Value.ToString());
                ...
                case "ObtenerCuentaContable":
                    ...
                    break;
                case "ObtenerParametroContable":
                    intIdLlave1 = int.Parse(parametrosJO.Property("IdParametro").Value.ToString());
                    ParametroContable parametroContable = _servicioContabilidad.ObtenerParametroContable(intIdLlave1);
                    if (parametroContable != null)
