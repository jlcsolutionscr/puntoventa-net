...
namespace LeandroSoftware.ServicioWeb.WebServer.Controllers
{
    ...
    public class PuntoventaController : ControllerBase
    {
        ...
        {
            IList<TiqueteDespachoMercancia> listadoTiqueteOrdenServicio = _servicioFacturacion.ObtenerListadoTiqueteOrdenServicio(idempresa, idsucursal, 0, categoria, true, false);
            string strRespuesta = "";
