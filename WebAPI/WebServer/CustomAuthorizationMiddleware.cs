    ...
    public class CustomAuthorizationMiddleware
    {
        ...
        )
        {
            ...
            if (strPath.Length > 1)
            {
                ...
                if (!new string[] { "recibirrespuestahacienda", "enviarhistoricoerrores", "obtenerultimaversionapp", "obtenerlistadotiqueteordenserviciopendiente", "cambiarestadoaimpresotiqueteordenservicio", "descargaractualizacion", "obtenerlistadoempresasadministrador", "obtenerlistadoempresas", "validarcredenciales", "validarcredencialesweb", "validarcredencialesadmin", "obtenerlistadoterminalesdisponibles", "registrarterminal", "procesarpendientes" }.Contains(strPath[1]))
                {
