...
namespace LeandroSoftware.ServicioWeb.Servicios
{
    public interface IFacturacionService
    {
        ...
        IList<TiqueteOrdenServicio> ObtenerListadoTiqueteOrdenServicio(int intIdEmpresa, int intIdSucursal, int intIdOrden, string strImpresora, bool bolFiltrarPendientes, bool bolSortedDesc);
    ...
    public class FacturacionService : IFacturacionService
    {
        ...
        public IList<TiqueteOrdenServicio> ObtenerListadoTiqueteOrdenServicio(int intIdEmpresa, int intIdSucursal, int intIdOrden, string strImpresora, bool bolFiltrarPendientes, bool bolSortedDesc)
        {
            if (_serviceScopeFactory == null) throw new Exception("Service factory not set");
            using (var dbContext = _serviceScopeFactory.CreateScope().ServiceProvider.GetRequiredService<LeandroContext>())
            {
