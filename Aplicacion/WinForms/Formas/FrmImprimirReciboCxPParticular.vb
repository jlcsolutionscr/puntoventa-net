...
Public Class FrmImprimirReciboCxPParticular
#Region "Variables"
    Private I As Short
...
#Region "Métodos"
    ...
    Private Sub CargarDetalleMovimiento(ByVal intIdParticular As Integer)
        dtbDetalleMovimiento.Rows.Clear()
        Try
            listadoMovimientos = servicioCuentaPorPagar.ObtenerListaMovimientos(StaticTipoCuentaPorPagar.Particulares, intIdParticular)
...
#Region "Eventos Controles"
    Private Sub FrmAnulaReciboCxPP_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        Try
            ...
            If grdDetalleRecibo.CurrentRow.Cells(0).Value.ToString <> "" Then
                ...
                For Each desgloseMovimiento As DesgloseMovimientoCuentaPorPagar In movimientoCuentaPorPagar.DesgloseMovimientoCuentaPorPagar
                    desglosePagoImpresion = New ModuloImpresion.clsDesgloseFormaPago With {
                        .strDescripcion = desgloseMovimiento.CuentaPorPagar.Referencia,
    ...
    Private Sub btnBuscarParticular_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnBuscarParticular.Click
        ...
        If FrmMenuPrincipal.intBusqueda > 0 Then
            ...
            CargarDetalleMovimiento(particular.IdParticular)
        End If
    End Sub
#End Region
End Class