...
Public Class FrmAplicaReciboCxPParticular
#Region "Variables"
...
#Region "Métodos"
    Private Sub IniciaDetalleMovimiento()
        ...
        dtbDesgloseCuenta.Columns.Add("DOCORIGINAL", GetType(String))
    ...
    Private Sub EstablecerPropiedadesDataGridView()
        ...
        dvcDescBanco.HeaderText = "Tipo Banco"
    ...
    Private Sub CargarLineaDesgloseCuenta()
        ...
        Else
            ...
            dtrRowDesgloseCuenta.Item(3) = cuentaPorPagar.Referencia
    ...
    Private Sub CargarLineaDesglosePago()
        ...
        If dtbDesglosePago.Rows.Contains(objPkDesglose) Then
            ...
            dtbDesglosePago.Rows(intIndice).Item(5) = txtNombre.Text
        ...
        Else
            ...
            dtrRowDesglosePago.Item(5) = txtNombre.Text
...
#Region "Eventos Controles"
    ...
    Private Sub CmdGuardar_Click(sender As Object, e As EventArgs) Handles CmdGuardar.Click
        If particular Is Nothing Or txtFecha.Text = "" Or Recibo.Text = "" Or txtDescripcion.Text = "" Then
        ...
        movimiento = New MovimientoCuentaPorPagar With {
            ...
            .TipoPropietario = StaticTipoCuentaPorPagar.Particulares,
            .Recibo = Recibo.Text,
    ...
    Private Sub btnBuscarParticular_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnBuscarParticular.Click
        ...
        If FrmMenuPrincipal.intBusqueda > 0 Then
            ...
            bolInit = True
            Try
                'cboCuentaPorPagar.DataSource = servicioCuentaPorPagar.ObtenerListaCuentasPorPagarPorPropietario(StaticTipoCuentaPorPagar.Particulares, particular.IdParticular)
