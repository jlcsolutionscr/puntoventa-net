...
#Region "Eventos Controles"
    Private Async Sub FrmCierre_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ...
        Try
            cierreCaja = Await Puntoventa.GenerarDatosCierreCaja(FrmPrincipal.empresaGlobal.IdEmpresa, Today, FrmPrincipal.usuarioGlobal.Token)
    ...
    Private Sub btnImprimir_Click(sender As Object, e As EventArgs) Handles btnImprimir.Click
        ...
        'Try
        '    lstReporte = Await Puntoventa.ObtenerReporteCierreDeCaja(cierreCaja.IdCierre)
        'Catch ex As Exception
        '    MessageBox.Show(ex.Message, "Leandro Software", MessageBoxButtons.OK, MessageBoxIcon.Error)
        '    Exit Sub
        'End Try
    ...
    Private Async Sub FrmCierreDeCaja_Closing(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Try
            If (Not cierreCaja Is Nothing) Then
                Await Puntoventa.AbortarCierreCaja(cierreCaja.IdEmpresa, FrmPrincipal.usuarioGlobal.Token)
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Leandro Software", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
