...
Public Class rptReciboCxC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.rptReciboCxC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReciboCxC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReciboCxC = New rptReciboCxC()
        rpt.Site = Me.Site
        Return rpt
    End Function
