...
Public Class rptVentasPorVendedor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptVentasPorVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.rptVentasPorVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasPorVendedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasPorVendedor = New rptVentasPorVendedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
