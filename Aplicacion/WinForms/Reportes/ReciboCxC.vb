...
Public Class ReciboCxC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.ReciboCxC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReciboCxC
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReciboCxC = New ReciboCxC()
        rpt.Site = Me.Site
        Return rpt
    End Function
