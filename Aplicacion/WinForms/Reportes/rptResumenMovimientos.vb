...
Public Class rptResumenMovimientos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptResumenMovimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.rptResumenMovimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenMovimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenMovimientos = New rptResumenMovimientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
