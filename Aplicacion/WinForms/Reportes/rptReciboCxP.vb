...
Public Class rptReciboCxP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.rptReciboCxP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReciboCxP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReciboCxP = New rptReciboCxP()
        rpt.Site = Me.Site
        Return rpt
    End Function
