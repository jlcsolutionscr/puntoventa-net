...
Public Class rptDetalleEgresos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.rptDetalleEgresos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalleEgresos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalleEgresos = New rptDetalleEgresos()
        rpt.Site = Me.Site
        Return rpt
    End Function
