...
Public Class rptDetalleIngresos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.rptDetalleIngresos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetalleIngresos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetalleIngresos = New rptDetalleIngresos()
        rpt.Site = Me.Site
        Return rpt
    End Function
