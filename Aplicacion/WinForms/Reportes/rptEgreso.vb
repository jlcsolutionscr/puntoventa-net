...
Public Class rptEgreso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.rptEgreso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEgreso
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEgreso = New rptEgreso()
        rpt.Site = Me.Site
        Return rpt
    End Function
