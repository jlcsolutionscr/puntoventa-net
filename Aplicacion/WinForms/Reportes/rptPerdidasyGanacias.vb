...
Public Class rptPerdidasyGanacias
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPerdidasyGanacias.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.rptPerdidasyGanacias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPerdidasyGanacias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPerdidasyGanacias = New rptPerdidasyGanacias()
        rpt.Site = Me.Site
        Return rpt
    End Function
