...
Public Class rptAbonoCxC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LeandroSoftware.Puntoventa.Aplicacion.WinForms.rptAbonoCxC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAbonoCxC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAbonoCxC = New rptAbonoCxC()
        rpt.Site = Me.Site
        Return rpt
    End Function
