                        ...
                        try
                        {
                            ...
                            while (operacion != "S")
                            {
                                ...
                                if (operacion == "P")
                                {
                                    ...
                                    {
                                        Console.WriteLine("Error al obtener la lista de documentos en proceso: " + ex.Message);
                                        Console.WriteLine("");
                                    }
                                ...
                                else if (operacion == "C")
                                {
                                    ...
                                    {
                                        Console.WriteLine("Error al obtener la lista de documentos procesados: " + ex.Message);
                                        Console.WriteLine("");
                                    }
                                    foreach (DocumentoElectronico doc in documentoLista)
                                    {
