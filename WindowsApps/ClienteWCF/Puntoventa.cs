...
namespace LeandroSoftware.ClienteWCF
{
    public static class Puntoventa
    {
        ...
        public static async Task ReversarMovimientoBanco(int intIdMovimiento, int intIdUsuario, string strMotivo, string strToken)
        {
            string strDatos = "{NombreMetodo: 'ReversarMovimientoBanco', Parametros: {IdMovimiento: " + intIdMovimiento + ", IdUsuario: " + intIdUsuario + ", MotivoAnulacion: '" + strMotivo + "'}}";
            await Ejecutar(strDatos, strServicioPuntoventaURL, strToken);
        }
