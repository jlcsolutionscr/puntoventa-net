...
#Region "Eventos Controles"
    Private Sub FrmAplicaAbonoApartado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        KeyPreview = True
    ...
    Private Sub FrmAplicaAbonoApartado_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub FrmAplicaAbonoApartado_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        Try
    ...
    Private Async Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        ElseIf decSaldoPorPagar > 0 Then
            MessageBox.Show("El total del desglose de pago no es suficiente para cubrir el saldo por pagar.", "JLC Solutions CR", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Exit Sub
        ElseIf decSaldoPorPagar < 0 Then
        ...
        For I As Short = 0 To dtbDesglosePago.Rows.Count - 1
            desglosePagoMovimiento = New DesglosePagoMovimientoApartado With {
                ...
                .IdCuentaBanco = IIf(dtbDesglosePago.Rows(I).Item(0) = StaticFormaPago.Efectivo, 0, dtbDesglosePago.Rows(I).Item(2)),
    ...
    Private Sub BtnInsertarPago_Click(sender As Object, e As EventArgs) Handles btnInsertarPago.Click
        If decTotal = 0 Then
            MessageBox.Show("No ha seleccionado el apartado por procesar. . .", "JLC Solutions CR", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Async Sub btnBuscarApartado_Click(sender As Object, e As EventArgs) Handles btnBuscarApartado.Click
        Dim formBusquedaApartado As New FrmBusquedaApartado()
        FrmPrincipal.intBusqueda = 0
        formBusquedaApartado.bolExcluyeCancelados = True
        formBusquedaApartado.ShowDialog()
        If FrmPrincipal.intBusqueda > 0 Then
            Try
            ...
            End Try
            dtbDesglosePago.Rows.Clear()
            txtId.Text = apartado.ConsecApartado
            txtMontoOriginal.Text = FormatNumber(apartado.Total, 2)
            txtTotalAbonado.Text = FormatNumber(apartado.MontoAdelanto, 2)
    ...
    Private Sub TxtMonto_KeyPress(sender As Object, e As PreviewKeyDownEventArgs) Handles txtMonto.PreviewKeyDown
        If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Tab Then
            ...
            If apartado Is Nothing Then
                MessageBox.Show("Debe seleccionar el registro del apartado", "JLC Solutions CR", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            ...
            ElseIf CDec(txtMonto.Text) > apartado.Total - apartado.MontoAdelanto Then
                ...
                txtMonto.Text = FormatNumber(apartado.Total - apartado.MontoAdelanto, 2)
            End If
