...
#Region "Métodos"
    ...
    Private Async Sub CargarLineaDesglosePago()
        ...
        If dtbDesglosePago.Rows.Contains(objPkDesglose) Then
            ...
            Exit Sub
        End If
        Dim decTipoCambio As Decimal = Await FrmPrincipal.ObtenerTipoDeCambioDolar(apartado.IdTipoMoneda)
...
#Region "Eventos Controles"
    ...
    Private Async Sub FrmAplicaAbonoApartado_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        Try
    ...
    Private Sub BtnImprimir_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnImprimir.Click
        reciboComprobante = New ModuloImpresion.ClsRecibo With {
            ...
            .strSaldoActual = FormatNumber(Decimal.Parse(txtSaldoActual.Text) - decTotal, 2),
    ...
    Private Sub TxtMonto_KeyPress(sender As Object, e As PreviewKeyDownEventArgs) Handles txtMonto.PreviewKeyDown
        If e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Tab Then
            ...
            If CDec(txtMonto.Text) > apartado.Total - apartado.MontoAdelanto Then
                ...
                txtMonto.Text = apartado.Total - apartado.MontoAdelanto
            End If
