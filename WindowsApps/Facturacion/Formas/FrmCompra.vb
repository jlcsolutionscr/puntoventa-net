...
#Region "Métodos"
    ...
    Private Sub EstablecerPropiedadesDataGridView()
        ...
        Dim dvcPrecioVentaAnt As New DataGridViewTextBoxColumn
        ...
        dvcPrecioVentaAnt.DataPropertyName = "PRECIOVENTAANT"
        dvcPrecioVentaAnt.HeaderText = "P. Venta"
        dvcPrecioVentaAnt.Visible = False
        grdDetalleCompra.Columns.Add(dvcPrecioVentaAnt)
    ...
    Private Sub CargarLineaDetalleCompra(ByVal producto As Producto, intCantidad As Integer, decPrecioCosto As Decimal, decPrecioVenta As Decimal)
        ...
        If Not producto.EsServicio And intIndice >= 0 Then
            ...
            dtbDetalleCompra.Rows(intIndice).Item(7) = dtbDetalleCompra.Rows(intIndice).Item(5) * dtbDetalleCompra.Rows(intIndice).Item(6)
        ...
        Else
            ...
            dtrRowDetCompra.Item(7) = dtrRowDetCompra.Item(5) * dtrRowDetCompra.Item(6)
    ...
    Private Sub CargarTotalesPago()
        ...
        For I As Short = 0 To dtbDesglosePago.Rows.Count - 1
            decTotalPago = decTotalPago + CDec(dtbDesglosePago.Rows(I).Item(5))
        Next
        decSaldoPorPagar = decTotal - decTotalPago
        txtMontoPago.Text = FormatNumber(decSaldoPorPagar, 2)
        txtSaldoPorPagar.Text = FormatNumber(decSaldoPorPagar, 2)
...
#Region "Eventos Controles"
        ...
        ElseIf e.KeyCode = Keys.F2 Then
            If FrmPrincipal.empresaGlobal.HabilitaCodigoTransitorio And FrmPrincipal.productoTranstorio IsNot Nothing Then
                ...
                If FrmPrincipal.productoTranstorio.PrecioVenta1 > 0 Then
                    ...
                    decPrecioVenta = 0
                    Dim decPrecioCosto As Decimal = producto.PrecioVenta1 / (1 + (FrmPrincipal.ObtenerTarifaImpuesto(producto.IdImpuesto) / 100))
    ...
    Private Sub txtPrecioCosto_Validated(sender As Object, e As EventArgs) Handles txtPrecioCosto.Validated
        ...
        txtUtilidad.Text = FormatNumber(decPorcUtilidad, 2)
    End Sub
