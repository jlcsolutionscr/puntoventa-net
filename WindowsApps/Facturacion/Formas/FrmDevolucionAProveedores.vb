    ...
    Private Sub CargarCompra(intIdCompra As Integer)
        Try
            ...
            If compra IsNot Nothing Then
                ...
                CargarTotales()
            Else
                MessageBox.Show("El número de compra ingresado no existe. Por favor verifique.", "JLC Solutions CR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
...
#Region "Eventos Controles"
    Private Sub FrmDevolucionAProveedores_Load(sender As Object, e As EventArgs) Handles MyBase.Load
