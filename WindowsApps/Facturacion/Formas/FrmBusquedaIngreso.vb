...
#Region "Métodos"
    ...
    Private Async Function ActualizarDatos(ByVal intNumeroPagina As Integer) As Task
        Try
            ...
            If intCantidadDePaginas > 0 Then
                listado = Await Puntoventa.ObtenerListadoIngresos(FrmPrincipal.empresaGlobal.IdEmpresa, cboSucursal.SelectedValue, intNumeroPagina, intFilasPorPagina, intId, "", txtDetalle.Text, FechaFinal.Text, FrmPrincipal.usuarioGlobal.Token)
            End If
    ...
    Private Async Function ValidarCantidadRegistros() As Task
        intTotalRegistros = Await Puntoventa.ObtenerTotalListaIngresos(FrmPrincipal.empresaGlobal.IdEmpresa, cboSucursal.SelectedValue, intId, "", txtDetalle.Text, FechaFinal.Text, FrmPrincipal.usuarioGlobal.Token)
...
#Region "Eventos Controles"
    Private Sub FrmBusquedaIngreso_Load(sender As Object, e As EventArgs) Handles MyBase.Load
