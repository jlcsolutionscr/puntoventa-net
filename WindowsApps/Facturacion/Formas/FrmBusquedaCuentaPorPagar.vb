...
#Region "Métodos"
    ...
    Private Async Function ActualizarDatos(ByVal intNumeroPagina As Integer) As Task
        Try
            ...
            If intCantidadDePaginas > 0 Then
                listado = Await Puntoventa.ObtenerListadoCuentasPorPagar(FrmPrincipal.empresaGlobal.IdEmpresa, cboSucursal.SelectedValue, bolPendientes, intNumeroPagina, intFilasPorPagina, txtReferencia.Text, txtNombre.Text, FrmPrincipal.usuarioGlobal.Token)
            End If
    ...
    Private Async Function ValidarCantidadCxP() As Task
        Try
            intTotalRegistros = Await Puntoventa.ObtenerTotalListaCuentasPorPagar(FrmPrincipal.empresaGlobal.IdEmpresa, cboSucursal.SelectedValue, bolPendientes, txtReferencia.Text, txtNombre.Text, FrmPrincipal.usuarioGlobal.Token)
        Catch ex As Exception
            MessageBox.Show(ex.Message, "JLC Solutions CR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Close()
            Exit Function
