...
#Region "Eventos Formulario"
    Private Async Sub FrmPrincipal_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ...
        Catch ex As Exception
            MessageBox.Show("Error al cargar el archivo de configuraci�n del sistema. Por favor contacte con su proveedor del servicio. . .", "JLC Solutions CR", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Close()
            Exit Sub
        End Try
        Try
        ...
        Else
            ...
            If Not ValidarEmpresa(empresa, credenciales) Then
                If usuarioGlobal.RolePorUsuario.Where(Function(s) s.IdRole = 61).Count > 0 Then
                    MessageBox.Show("La informaci�n de la empresa requiere ser actualizada. Por favor ingrese al mantenimiento de Empresa para completar la informaci�n.", "JLC Solutions CR", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Try
                    ...
                    End Try
                Else
                    MessageBox.Show("La informaci�n de la empresa requiere ser actualizada por un usuario administrador.", "JLC Solutions CR", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Close()
                    Exit Sub
                End If
            Else
