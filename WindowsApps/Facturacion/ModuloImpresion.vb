...
#Region "Métodos"
    ...
    Public Shared Sub ImprimirCierreEfectivo(objImpresion As ClsCierreCaja)
        ...
        Try
            ...
            lineas.Add(New ClsLineaImpresion(1, "Desglose de pagos", 0, 100, 10, StringAlignment.Center, False))
            lineas.Add(New ClsLineaImpresion(0, "Efectivo", 0, 100, 10, StringAlignment.Near, True))
            ...
            lineas.Add(New ClsLineaImpresion(0, "Total de pagos", 0, 100, 10, StringAlignment.Near, False))
            lineas.Add(New ClsLineaImpresion(2, objImpresion.strTotalVentas, 0, 100, 10, StringAlignment.Far, False))

            lineas.Add(New ClsLineaImpresion(1, "Desglose de adelantos", 0, 100, 10, StringAlignment.Center, False))
            lineas.Add(New ClsLineaImpresion(0, "Efectivo", 0, 100, 10, StringAlignment.Near, True))
            ...
            lineas.Add(New ClsLineaImpresion(0, "Transferencia", 0, 100, 10, StringAlignment.Near, True))
