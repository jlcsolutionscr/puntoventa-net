...
--
ALTER TABLE tiqueteordenservicio ADD PRIMARY KEY (IdTiquete);

ALTER TABLE tiqueteordenservicio MODIFY IdTiquete int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE tiqueteordenservicio
  ADD CONSTRAINT tiqueteordenservicio_ibfk_1 FOREIGN KEY (IdOrden) REFERENCES ordenservicio (IdOrden),
  ADD CONSTRAINT tiqueteordenservicio_ibfk_2 FOREIGN KEY (IdEmpresa, IdSucursal) REFERENCES sucursalporempresa (IdEmpresa, IdSucursal);
