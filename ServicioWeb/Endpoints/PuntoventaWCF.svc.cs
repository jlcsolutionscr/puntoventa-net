            ...
            try
            {
                ...
                switch (strNombreMetodo)
                {
                    ...
                    case "ObtenerTotalListaClasificacionProducto":
                        ...
                        intTotalLista = servicioMantenimiento.ObtenerTotalListaClasificacionProducto(strDescripcion);
                    ...
                    case "ObtenerListadoClasificacionProducto":
                        ...
                        strDescripcion = parametrosJO.Property("Descripcion") != null ? parametrosJO.Property("Descripcion").Value.ToString() : "";
                        IList<ClasificacionProducto> listadoClasificacionProducto = servicioMantenimiento.ObtenerListadoClasificacionProducto(intNumeroPagina, intFilasPorPagina, strDescripcion);
                    ...
                    case "ObtenerReporteVentasPorLineaResumen":
                        ...
                        strFechaInicial = parametrosJO.Property("FechaInicial").Value.ToString();
                        strFechaFinal = parametrosJO.Property("FechaFinal").Value.ToString();
                        IList<DescripcionValor> listadoReporteVentasPorLineaResumen = servicioReportes.ObtenerReporteVentasPorLineaResumen(intIdEmpresa, intIdSucursal, strFechaInicial, strFechaFinal);
                    ...
                    case "ObtenerReporteVentasPorLineaDetalle":
                        ...
                        strFechaInicial = parametrosJO.Property("FechaInicial").Value.ToString();
                        strFechaFinal = parametrosJO.Property("FechaFinal").Value.ToString();
                        IList<ReporteGrupoLineaDetalle> listadoReporteVentasPorLineaDetalle = servicioReportes.ObtenerReporteVentasPorLineaDetalle(intIdEmpresa, intIdSucursal, intIdLlave1, strFechaInicial, strFechaFinal);
                    ...
                    case "ObtenerTotalListaProductos":
                        ...
                        strCodigoProveedor = parametrosJO.Property("CodigoProveedor") != null ? parametrosJO.Property("CodigoProveedor").Value.ToString() : "";
                        strDescripcion = parametrosJO.Property("Descripcion") != null ? parametrosJO.Property("Descripcion").Value.ToString() : "";
                        intTotalLista = servicioMantenimiento.ObtenerTotalListaProductos(intIdEmpresa, intIdSucursal, bolIncluyeServicios, bolFiltraActivos, bolFiltraExistencias, bolFiltraConDescuento, intIdLlave1, strCodigo, strCodigoProveedor, strDescripcion);
                        strRespuesta = serializer.Serialize(intTotalLista);
                        break;
                    ...
                    case "ObtenerTotalListaFacturas":
                        ...
                        intTotalLista = servicioFacturacion.ObtenerTotalListaFacturas(intIdEmpresa, intIdSucursal, intIdLlave1, strNombre, strIdentificacion);
                        strRespuesta = serializer.Serialize(intTotalLista);
                        break;
                    case "ObtenerListadoFacturas":
                        ...
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        strIdentificacion = parametrosJO.Property("Identificacion") != null ? parametrosJO.Property("Identificacion").Value.ToString() : "";
                        IList<FacturaDetalle> listadoFacturas = servicioFacturacion.ObtenerListadoFacturas(intIdEmpresa, intIdSucursal, intNumeroPagina, intFilasPorPagina, intIdLlave1, strNombre, strIdentificacion);
                    ...
                    case "ObtenerTotalListaCompras":
                        ...
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        intTotalLista = servicioCompra.ObtenerTotalListaCompras(intIdEmpresa, intIdSucursal, intIdLlave1, strClave, strNombre);
                        strRespuesta = serializer.Serialize(intTotalLista);
                        break;
                    case "ObtenerListadoCompras":
                        ...
                        strClave = parametrosJO.Property("RefFactura") != null ? parametrosJO.Property("RefFactura").Value.ToString() : "";
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        IList<CompraDetalle> listadoCompras = (List<CompraDetalle>)servicioCompra.ObtenerListadoCompras(intIdEmpresa, intIdSucursal, intNumeroPagina, intFilasPorPagina, intIdLlave1, strClave, strNombre);
                    ...
                    case "ObtenerTotalListaProformas":
                        ...
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        intTotalLista = servicioFacturacion.ObtenerTotalListaProformas(intIdEmpresa, intIdSucursal, bolAplicado, intIdLlave1, strNombre);
                        strRespuesta = serializer.Serialize(intTotalLista);
                        break;
                    case "ObtenerListadoProformas":
                        ...
                        intIdLlave1 = parametrosJO.Property("IdProforma") != null ? int.Parse(parametrosJO.Property("IdProforma").Value.ToString()) : 0;
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        IList<FacturaDetalle> listadoProformas = servicioFacturacion.ObtenerListadoProformas(intIdEmpresa, intIdSucursal, bolAplicado, intNumeroPagina, intFilasPorPagina, intIdLlave1, strNombre);
                    ...
                    case "ObtenerTotalListaOrdenServicio":
                        ...
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        intTotalLista = servicioFacturacion.ObtenerTotalListaOrdenServicio(intIdEmpresa, intIdSucursal, bolAplicado, intIdLlave1, strNombre);
                        strRespuesta = serializer.Serialize(intTotalLista);
                        break;
                    case "ObtenerListadoOrdenServicio":
                        ...
                        intIdLlave1 = parametrosJO.Property("IdOrdenServicio") != null ? int.Parse(parametrosJO.Property("IdOrdenServicio").Value.ToString()) : 0;
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        IList<FacturaDetalle> listadoOrdenServicio = servicioFacturacion.ObtenerListadoOrdenServicio(intIdEmpresa, intIdSucursal, bolAplicado, intNumeroPagina, intFilasPorPagina, intIdLlave1, strNombre);
                    ...
                    case "ObtenerTotalListaApartados":
                        ...
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        intTotalLista = servicioFacturacion.ObtenerTotalListaApartados(intIdEmpresa, intIdSucursal, bolAplicado, intIdLlave1, strNombre);
                        strRespuesta = serializer.Serialize(intTotalLista);
                        break;
                    case "ObtenerListadoApartados":
                        ...
                        intIdLlave1 = parametrosJO.Property("IdApartado") != null ? int.Parse(parametrosJO.Property("IdApartado").Value.ToString()) : 0;
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        IList<FacturaDetalle> listadoApartados = servicioFacturacion.ObtenerListadoApartados(intIdEmpresa, intIdSucursal, bolAplicado, intNumeroPagina, intFilasPorPagina, intIdLlave1, strNombre);
                    ...
                    case "ObtenerTotalDocumentosElectronicosProcesados":
                        ...
                        intIdSucursal = int.Parse(parametrosJO.Property("IdSucursal").Value.ToString());
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        int intTotalDocumentosProcesados = servicioFacturacion.ObtenerTotalDocumentosElectronicosProcesados(intIdEmpresa, intIdSucursal, strNombre);
                    ...
                    case "ObtenerListadoDocumentosElectronicosProcesados":
                        ...
                        intFilasPorPagina = int.Parse(parametrosJO.Property("FilasPorPagina").Value.ToString());
                        strNombre = parametrosJO.Property("Nombre") != null ? parametrosJO.Property("Nombre").Value.ToString() : "";
                        IList<DocumentoDetalle> listadoProcesados = servicioFacturacion.ObtenerListadoDocumentosElectronicosProcesados(intIdEmpresa, intIdSucursal, intNumeroPagina, intFilasPorPagina, strNombre);
