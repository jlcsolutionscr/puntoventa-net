...
-- Tiempo de generación: 24-09-2019 a las 14:32:52
...
-- Procedimientos
--
CREATE DEFINER=jasonCR_conn@`%` PROCEDURE MarcaRegistrosProcesados(intIdEmpresa INT)
BEGIN
...
-- Funciones
--
CREATE DEFINER=jasonCR_conn@`%` FUNCTION DiffDays(dateFrom DATE, dateTo DATE) RETURNS int(11)
